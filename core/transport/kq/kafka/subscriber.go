...
//}
//
//func (s *Subscriber) consumeMessages(ctx context.Context, topic string, output chan *Message, logFields watermill.LogFields) (consumeMessagesClosed chan struct{}, err error) {
...
//			h.logger.Info("Message sent to consumer", receivedMsgLogFields)
//		case <-h.closing:
//			h.logger.Info("Closing, message discarded", receivedMsgLogFields)
//			return nil
//		case <-ctx.Done():
//			h.logger.Info("Closing, ctx cancelled before sent to consumer", receivedMsgLogFields)
//			return nil
//		}
//
//		select {
...
//			}
//			h.logger.Info("Message Acked", receivedMsgLogFields)
//			break ResendLoop
//		case <-msg.Nacked():
...
//			continue ResendLoop
//		case <-h.closing:
//			h.logger.Info("Closing, message discarded before ack", receivedMsgLogFields)
//			return nil
//		case <-ctx.Done():
//			h.logger.Info("Closing, ctx cancelled before ack", receivedMsgLogFields)
//			return nil
//		}
//	}
//
